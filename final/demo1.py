...
pin=0
power=0
scene = display(x=500,y=0,background=(0.5,0.5,0))
#curve
scene1 = gdisplay(x=0, y=0, width=500, height=400, xtitle='t', ytitle='i', background=(0.2, 0.6, 0.2))
scene2 = gdisplay(x=0, y=400, width=500, height=400, xtitle='t', ytitle='avepower', background=(0.2, 0.6, 0.2))
