...
while True:
    ...
    if int(t/dt)%1000==0:
         tau = t*N/(count) #to be found
         theoretical=q*E*tau/m
         reality=vv/t*dt
         Error=abs(reality-theoretical)/abs(theoretical)
         print "Tau = ",tau
         print "Theoretical drift velocity = ",theoretical
         print "The reality drift velocity = ",reality
         print "Drift percentage = ",Error*100,"%"
         vd_ball.pos = vv/(t/dt)
